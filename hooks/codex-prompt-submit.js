#!/usr/bin/env node
// myanget — Codex UserPromptSubmit hook to track which myanget mode is active
...
const { clearMode, isCodex, readMode, setMode, writeHookOutput } = require('./myanget-runtime');
